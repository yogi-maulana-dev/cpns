...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDvnP6-IQADuP461VqlXqYjdm6sWlkhVWs';  //OR AIzaSyDzvhEg4efwXcYvdMvRLDGUEau4vjh8klg						
	// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "2.55553348, -261.67425156";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	function add_polygon($params = array())
	{
		...
		if ($polygon['onclick']!="") { 
			$polygon_output .= '
			google.maps.event.addListener(polygon_'.count($this->polygons).', "click", function(event) {
				'.$polygon['onclick'].'
			});
			';
		}
